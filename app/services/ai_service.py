...
- НЕ начинай с приветствия или обращения по имени (никаких "Дорогой/Дорогая", "Привет" и т.п.)
- Начинай сразу с содержательной части гороскопа
- Гороскоп должен быть конкретным и применимым к жизни человека
- Длина: 100-150 слов (коротко и по делу)
...
def _safe_fallback(name: str, zodiac_sign: str) -> str:
    ...
    return (
        f"Сегодня звезды советуют быть внимательнее к знакам вселенной. "
        f"Как {zodiac_sign}, ты обладаешь особой интуицией - "
        f"доверься ей. День благоприятен для новых начинаний "
